...
describe('FinanceItem component', () => {
  it('renders without crashing', () => {
    render(
      <Provider store={store}>
        <FinanceItem item={stocks[0]}/>
      </Provider>
    );
  });
  ...
  it('renders with arrow down', () => {
    ...
    const arrowItem = screen.queryByTestId('arrow-down');
  ...
  it('renders with arrow up', () => {
    render(
      <Provider store={store}>
        <FinanceItem item={stocks[1]}/>
      </Provider>
    );

    const arrowItem = screen.queryByTestId('arrow-up');
    expect(arrowItem).toBeInTheDocument();
  });
